...
export interface StakeContract1Interface extends ethers.utils.Interface {
  functions: {
...
export interface StakeContract1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeContract1Interface;
