...
export interface OlympusERC20ContractInterface extends ethers.utils.Interface {
  functions: {
...
export interface OlympusERC20Contract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OlympusERC20ContractInterface;
